...
namespace zxeltor.StoCombatAnalyzer.Lib.Model.Realtime;
...
public class RealtimeCombatEntity : INotifyPropertyChanged
{
    ...
    public RealtimeCombatEntity(CombatEvent combatEvent, RealtimeCombatLogParseSettings combatLogParseSettings) : this() 
    {
        ...
        _combatLogParseSettings = combatLogParseSettings;
    ...
    public bool IsInCombat { get => this._isInCombat; set => SetField(ref this._isInCombat, value); }
