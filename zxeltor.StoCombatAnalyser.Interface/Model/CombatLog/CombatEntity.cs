...
public class CombatEntity : INotifyPropertyChanged
{
    ...
    /// </summary>
    public DateTime CombatStart => this.CombatEventList.Count == 0 ? DateTime.MinValue : this.CombatEventList.Min(ev => ev.Timestamp);
    ...
    /// </summary>
    public DateTime CombatEnd => this.CombatEventList.Count == 0 ? DateTime.MinValue : this.CombatEventList.Max(ev => ev.Timestamp);
