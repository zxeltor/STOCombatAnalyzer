...
public partial class DetailsDialog : Window
{
    ...
    /// </param>
    private DetailsDialog(Window? owner, bool isModalDialog, string message, string? caption = null,
    ...
    {
        var dialog = new DetailsDialog(owner, false, message, caption, includeCancel, detailsBoxCaption,
            detailsBoxList);
        dialog.Show();
    }
    ...
    public static bool ShowDialog(Window? owner, string message, string? caption = null, bool includeCancel = false,
        List<string>? detailsBoxList = null, string? detailsBoxCaption = null)
    {
        var dialog = new DetailsDialog(owner, true, message, caption, includeCancel, detailsBoxCaption, detailsBoxList);
